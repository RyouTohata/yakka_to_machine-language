...
使い方:
    python mhlw_price_converter_v5.py --input-dir . --output-dir output

任意:
    python mhlw_price_converter_v5.py --input-dir . --output-dir output --manual-aliases manual_aliases.json
"""
...
def build_meta_info(source_files: list[str]) -> MetaInfo:
    return MetaInfo(
        ...
        generator="mhlw_price_converter_v5",
